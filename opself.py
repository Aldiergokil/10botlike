...
cl.login(token="EnI7ef0Z3UezHQI6Wsd6.fuhmXP7FiLvOyAe2zzTr5G.1f9GaH52wery/iQf4j0b6W11ORT/LIm5xKCMhGNFE4g=")
cl.loginResult()

ki = LINETCR.LINE() #Bot 1
ki.login(token="En1shtykjVyBTiiCBri6.VwbvW2zP7tULSu5xLmRiDG.ElaG4Qyjxn14qvGXncPJndFAdWKz84ecvKXYdbG52qc=")
ki.loginResult()

kk = LINETCR.LINE() #Bot 2
kk.login(token="EnTLVpWJI60NdVzYTtl3.VmimZkOdegwQv4ovPOJ5KW.f/q42TQC2/11chZ4zvzVeYCmIOJZ280L1Ao8MJm3ShM=")
kk.loginResult()

kc = LINETCR.LINE() #Bot 3
kc.login(token="Enwhzxs5K0mNr0itnLT0.q4aje1y7dOuHXB7d+BZ1Ka.QV9ILeab37LEDVdzzefDFYTiCCkB3bKrOu4Q8WiWIM8=")
kc.loginResult()

ks = LINETCR.LINE() #Bot 4
ks.login(token="EnO7Sc3r5DcfbgTtbHC4.XC275fde+Pee+2vWKGAbva.c9b6dYLProTSmljJWmcjHNZyJEpN91GDuei/nPuS1VQ=")
ks.loginResult()

ka = LINETCR.LINE() #Bot 5
ka.login(token="EnPiGxbLPXrgMMRqgw55.TEPKWLTdsRpnlrRUUWIG9q.0BtgJWNxl6d4oKBcuZAd80rvmFTZSrt9Nlv8s1Ii/ss=")
ka.loginResult()

kb = LINETCR.LINE() #Bot 6
kb.login(token="EnxMkJ1BtybO7YBXwHid.iSmB2iOlOSiPsmKIwZJLBq.7Kpjk/pqGfbHhR8w5r4GUzOQz4FmwbT5u85cPsk6OHs=")
kb.loginResult()

ko = LINETCR.LINE() #Bot 7
ko.login(token="EnZX2mnIUr7BXOB1Y896.jHNqce+x4bQ9LANZM9HpjG.duIAfTUTX+P+VZQ0pQBAxIuMZ0QP7Hyh2iK8ohC7b2A=")
ko.loginResult()

ke = LINETCR.LINE() #Bot 8
ke.login(token="Enb3PTludxO0ED7gPH1b.ow9UMtSEO79Y9vxATM3l2W.p+1yM27k3STQh5OrRL7lND7zeXqvho8tRPIysiypQYI=")
ke.loginResult()

ku = LINETCR.LINE() #Bot 9
ku.login(token="EnJh0LE7V2eDIK75oND6.11pSwIGo9OKd2WrtjPKvXG.cOGQbM22Nx5m0flxkBOP1EFDq9RRSNmpbUKR8ZIzO6s=")
ku.loginResult()
...
owner=["u1541ccc69edf22556861a136659b51e6"]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Makasih dah add bot gokil",
    "lang":"JP",
...
def bot(op):
    try:
        ...
        if op.type == 25:
            ...
            elif "Meliodas invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("sinvite ","")
                ki.findAndAddContactsByMid(midd)
                ki.inviteIntoGroup(msg.to,[midd])
            elif "Ban invite " in msg.text:
              if msg.from_ in admin:
    ...
    #--------------------------------------
            ...
            elif msg.text in ["Meliodas buka qr","Meliodas open qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Ban buka qr","Ban open qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["King open qr","King buka qr"]:
                if msg.toType == 2:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Meliodas close qr","Meliodas tutup qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Ban tutup qr","Ban close qr"]:
                if msg.toType == 2:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kk.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kk.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["King tutup qr","King close qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
		...
		for ticket_id in n_links:
            ...
            elif "My Bot" == msg.text:
              if msg.from_ in admin:
                cl.sendText(msg.to,mid)
            elif "Meliodas" == msg.text:
              if msg.from_ in admin:
                ki.sendText(msg.to,Amid)
            elif "Ban" == msg.text:
              if msg.from_ in admin:
        ...
        #-------------Fungsi Jam on/off Start-------------------#            
         ...
         #-------------Fungsi Jam Update Finish-------------------#
                 ...
                 if msg.from_ in admin:
                    cl.sendText(msg.to, "Menunggu sider...")
                    try:
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "★Disiderin Oleh★%s\n\n↓Sider wajib taubat↓\n%sJangan jadi sider terus gak baik.\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        cl.sendText(msg.to, "Ceksider dulu\nSetelah itu Liatsider\nTua sih jadi lupa... ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Yuhu Sini","Bot join","Masuk"]:
              if msg.from_ in admin:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye bot","Bot out","Pulang","Out"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        ...
                        random.choice(KAC).sendText(msg.to,"Dasar Gak Guna")
                        return
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                #cl.sendText(msg.to,"Meliodas On")
                ki.sendText(msg.to,"Bot 1")
                kk.sendText(msg.to,"Bot 2")
                kc.sendText(msg.to,"Bot 3")
                ks.sendText(msg.to,"Bot 4")
                ka.sendText(msg.to,"Bot 5")
                kb.sendText(msg.to,"Bot 6")
                ko.sendText(msg.to,"Bot 7")
                ke.sendText(msg.to,"Bot 8")
                ku.sendText(msg.to,"Bot 9")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
                 ...
                 msg.contentType = 13
                 msg.contentMetadata = {'mid': 'u1541ccc69edf22556861a136659b51e6'}
                 cl.sendMessage(msg)
                 cl.sendText(msg.to,"Creator Aldier Gokil Bot")
...
#---------CCTV-----------
        ...
        if op.type == 17:
           ...
           random.choice(KAC).sendText(op.param1, "Yang Punya Grup " + str(ginfo.name) + " :\n" + ginfo.creator.displayName)
           random.choice(KAC).sendText(op.param1,"Silakan Cek Note..")
			...
			for zx in range(0,200):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By Aldier Gokil")
						ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"My Owner Aldier Gokil")
						kk.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"My Owner Aldier Gokil")
						kc.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kc.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"My Owner Aldier Gokil")
						ks.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						ks.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"My Owner Aldier Gokil")
						ka.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						ka.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"My Owner Aldier Gokil")
						kb.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						kb.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"My Owner Aldier Gokil")
						ko.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						ko.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"My Owner Aldier Gokil")
						ke.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						ke.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"My Owner Aldier Gokil")
						ku.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
						ku.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"My Owner Aldier Gokil")
						print "DiLike"
					except:
							pass
				else:
